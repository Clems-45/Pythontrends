class bedRoom:
    ...
    def chooSefunction(self):
        ...
        print("E for move to end class or return nothing and move on to next class maybe hall or dinning room")
...
# i wil use the the return function to return the function back to the loop

     #   elif bedroMspefs!="A" or bedroMspefs!="B" or bedroMspefs!="C" or bedroMspefs!="D" :



    #       Error handling can be be done on the alphabet choice whether if choice is not A or B or C or D then the error should be caught
